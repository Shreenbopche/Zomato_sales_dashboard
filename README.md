...
- **Weekday vs. weekend** revenue is proportional to the number of days — no weekend ordering spike.

## 🛠️ Built With

- Microsoft Excel (formulas: `SUMIFS`, `COUNTIFS`, `INDEX`/`MATCH`; native charts)
- Python (pandas) for initial data joining/flattening

## 🚀 How to Use

1. Download `Zomato_Sales_Dashboard.xlsx` and open it in Excel.
2. Start on the **Dashboard** tab for the high-level view.
3. Check the **Summary** tab to see the formulas behind each number.
4. Explore the **Data** tab (filterable table) to slice the raw data yourself, or build your own PivotTable from it.

---

*Built as a data analytics / dashboard project.*
